// import { adminSiderbarMenuItems } from "@/config";
    ...
    <nav className="mt-8 flex-col flex gap-2">
      {adminSiderbarMenuItems.map((menuItem) => (
        <div
          ...
          className="flex text-lg cursor-pointer item-center gap-2 rounded-md px-2 py-2 text-muted-foreground hover:bg-muted hover:text-foreground"
        >
          {menuItem.icons}
